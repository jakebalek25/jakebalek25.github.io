...
<div style="text-align:center;">
  <img sec="/images/secondbasecount1.png" alt="Table showing the distribution of events for the at-bat following in regular innings" width="75%">
  <img sec="/images/secondbasecount.png" alt="Table showing the distribution of events for the at-bat following in regular innings" width="90%">
</div>
